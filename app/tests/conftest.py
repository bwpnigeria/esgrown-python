...
def super_user(
    ...
    super_user_group = ac_models.Group(name="super_user_group")  # type: ignore
    alumni_user_group = ac_models.Group(name="alumni_user_group")  # type: ignore
    super_owner = ac_models.Role(name="super:owner")  # type: ignore

    for perm in all_perms:
        super_owner.permissions.append(ac_models.Permission(name=perm))  # type: ignore
