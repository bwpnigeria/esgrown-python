...
def test_update_user(crud_util: CrudUtil, user: models.User) -> Any:
    ...
    assert str(updated_user.email) == user_data.email
    assert str(updated_user.firstname) == str(user_data.firstname)
...
def test_request_password_reset(
    ...
    response = cruds.request_password_reset(crud_util, str(user.email))
...
def test_request_password_reset_invalid_email(
    ...
    response = cruds.request_password_reset(crud_util, str(gen_email()))
...
def test_reset_password(
    ...
    cruds.request_password_reset(crud_util, str(user.email))
    password_reset_link = password_reset_mailbox.read_text().strip()
...
def test_change_admin_user_password(
    ...
    assert verify_password_hash(
        admin_password, str(db_user.password_hash)  # type:ignore
    )
